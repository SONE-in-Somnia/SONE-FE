...
export default function GradientText({
  ...
  return (
    <div
      className={`relative flex max-w-fit cursor-pointer flex-row items-start justify-center overflow-hidden rounded-[1.25rem] text-left font-medium backdrop-blur transition-shadow duration-500 ${className}`}
    >
      {showBorder && (
        <div
