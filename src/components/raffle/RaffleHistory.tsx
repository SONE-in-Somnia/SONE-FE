...
import { RaffleDetailsType, RecentActivity } from '@/types/raffle';
...
const RaffleHistory = ({ raffle }: { raffle: RaffleDetailsType }) => {
  const { data: history, isLoading } = useGetPoolActivities({ poolId: raffle.prizePoolAddress }); // Use the new hook
